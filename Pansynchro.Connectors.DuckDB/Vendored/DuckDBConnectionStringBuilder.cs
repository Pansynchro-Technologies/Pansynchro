...
// This class, and various supporting types in this folder, are already in the DuckDB.NET
// repo, but the maintainer is taking a while to push it to NuGet.  Once the package is
// updated, this can all be removed.
