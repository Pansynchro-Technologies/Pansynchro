// Implements Python indentation rules.  Adapted from code found at
// https://github.com/antlr/grammars-v4/blob/master/python/python3/CSharp/Python3LexerBase.cs
	...
	public abstract class Python3LexerBase : Lexer
	{
		...
		public override IToken NextToken()
		{
			...
			if (InputStream.LA(1) == Eof && Indents.Count != 0) {
				...
				Emit(CommonToken(PansyncLexer.Eof, "<EOF>"));
			}
